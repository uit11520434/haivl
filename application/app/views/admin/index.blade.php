...
<div class="container admin">
	...
	<div class="col-md-3 col-lg-3 admin-left">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<a class="admin-block rounded-bottom-left rounded-bottom-right @if(Input::get('section') == 'plugins') active @endif" data-section="plugins" style="background:#1ABC9C" href="{{ URL::to('admin/plugins') }}">
					<i class="fa fa-puzzle-piece"></i><span>Plugins<?php // Lang::get('lang.plugins') ?></span>
				</a>
			</div>
