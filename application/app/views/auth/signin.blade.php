...
@section('css')
    <link rel="stylesheet" href="{{ URL::to('/') }}/application/assets/css/login_signup.css" />
    <style type="text/css">
...
<script type="text/javascript" src="{{ URL::to('/') }}/application/assets/js/jquery.backstretch.min.js"></script>
